...
@interface ZCPWebViewController () <WKNavigationDelegate, WKUIDelegate, ZCPGenerateURLDelegate>
...
- (void)motionBegan:(UIEventSubtype)motion withEvent:(UIEvent *)event{
    ...
    if ([[[ZCPSettingsManager sharedInstance].preference objectForKey:SETTINGID_SHAKE] boolValue]) {
